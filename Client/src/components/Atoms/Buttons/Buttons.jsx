...
const Button = ({
  ...
  const baseClasses = `px-4 cursor-pointer justify-center py-2 ${rounded} flex items-center gap-1 transition font-medium focus:outline-none focus:ring-2 focus:ring-offset-2`;
